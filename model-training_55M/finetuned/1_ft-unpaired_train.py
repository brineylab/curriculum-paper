...
def main():
    # run name
    args = parser()
    run_name = f"ft-unpaired_50M-ESM_62k-stp_{date.today().isoformat()}"

    # update config steps & warmup
    # total steps for unpaired phase: 100000 * 0.625 = 62500
    # warmup = 6% = 3,750
    MixedConfig["max_steps"] = 62500
    MixedConfig["warmup_steps"] = 3750
